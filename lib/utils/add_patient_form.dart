...
class _AddPatientFormState extends State<AddPatientForm> {
  ...
  void submitData() {
    ...
    if (name.isEmpty || surname.isEmpty || age.isEmpty || ward.isEmpty || hn.isEmpty || bedNum.isEmpty || _selectedGender == null) {
      showDialog(
        context: context,
            ...
            child: Column(
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text("addPatientData".tr(), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                      const Spacer(),
                      IconButton(
