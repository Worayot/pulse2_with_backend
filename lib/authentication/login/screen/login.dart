...
//TODO: Rewrite to use riverpod for remember me state management
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(children: [Text("nurseID".tr(), style: const TextStyle(fontSize: 16))]),
                          ...
                          Row(children: [Text("password".tr(), style: const TextStyle(fontSize: 16))]),
