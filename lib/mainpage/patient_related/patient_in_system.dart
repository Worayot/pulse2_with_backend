                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(child: FaIcon(FontAwesomeIcons.userPlus, color: Colors.white, size: 25)),
                      ),
                    ),
                    const Gap(8),
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        width: 60,
                        decoration: BoxDecoration(color: Color(0xff407BFF), borderRadius: BorderRadius.circular(12)),
                        child: Center(child: FaIcon(FontAwesomeIcons.filter, color: Colors.white, size: 25)),
                      ),
                    ),
                  ],
                ),
