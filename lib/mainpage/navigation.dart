        ...
        child: CustomAnimatedBottomBar(
          ...
          items: <BottomNavyBarItem>[
            BottomNavyBarItem(
              ...
              title: Text("\t${'patientsInSystem'.tr()}", style: TextStyle(fontSize: fontSize)),
            ...
            BottomNavyBarItem(
              ...
              title: Text("\t${'patientInMonitoring'.tr()}", style: TextStyle(fontSize: fontSize)),
              activeColor: const Color(0xffFEFEFE),
              inactiveColor: const Color(0xffC6D8FF),
              boxWidth: screenWidth * 0.4,
            ),
            BottomNavyBarItem(
              ...
              title: Text('data'.tr(), style: TextStyle(fontSize: fontSize)),
              activeColor: const Color(0xffFEFEFE),
              inactiveColor: const Color(0xffC6D8FF),
